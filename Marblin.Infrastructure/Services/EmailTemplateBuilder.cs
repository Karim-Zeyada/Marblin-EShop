...
{
    /// <summary>
    /// Shared HTML email template builder used by both SendGrid and SMTP services.
    /// Single source of truth for all email body content.
    /// </summary>
    internal static class EmailTemplateBuilder
    {
        public static (string subject, string htmlBody) BuildContactForm(
            string customerName, string customerEmail, string message)
        {
        ...
        public static (string subject, string htmlBody) BuildOrderConfirmation(
            string customerName, string orderNumber, decimal totalAmount, decimal depositAmount,
            string instapay, string vodafoneCash, string proofUrl,
        ...
        public static (string subject, string htmlBody) BuildPaymentProofReceived(
            string customerName, string orderNumber, Marblin.Core.Enums.PaymentMethod paymentMethod)
        {
        ...
        public static (string subject, string htmlBody) BuildDepositVerified(
            string customerName, string orderNumber, decimal totalAmount, decimal remainingBalance,
        ...
        public static (string subject, string htmlBody) BuildAwaitingBalance(
            string customerName, string orderNumber, decimal totalAmount, decimal depositPaid,
            decimal remainingBalance, string instapay, string vodafoneCash,
            Marblin.Core.Enums.PaymentMethod paymentMethod, string city, decimal cairoGizaShippingCost)
        {
        ...
        public static (string subject, string htmlBody) BuildOrderShipped(string customerName, string orderNumber)
        {
        ...
        public static (string subject, string htmlBody) BuildOrderCancelled(
            string customerName, string orderNumber, string reason)
        {
