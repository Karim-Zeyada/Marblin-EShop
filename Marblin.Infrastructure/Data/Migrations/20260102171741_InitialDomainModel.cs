        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentProofType = table.Column<int>(type: "int", nullable: false),
                    TransactionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ReceiptImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDepositVerified = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DepositVerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InProductionAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AwaitingBalanceAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueStatements = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ProcessSteps = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    InstapayAccount = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    VodafoneCashNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSignaturePiece = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomRequests_IsReviewed",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_IsSignaturePiece",
                table: "Products",
                column: "IsSignaturePiece");
